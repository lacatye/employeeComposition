...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		for (int i=1; i<=contracts; i++) {
			...
			HourContract contract = new HourContract(contractDate, valuePerHourWorker, workerHours);
			worker.addContract(contract);
		}
		
		// String to facilitate input manipulation and validation //
		// The slash counts as two, so three //
		System.out.println();
